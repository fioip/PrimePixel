...
function LensesDetails() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/api/lenses/${id}`)
      .then((response) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <FaCamera className="animate-bounce text-4xl text-orange-500 mx-auto mb-4" />
  ...
  const specifications = JSON.parse(lens.specifications);
